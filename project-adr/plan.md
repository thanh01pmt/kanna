...
### Giai đoạn 1: "Thổi hồn" vào Right Sidebar (Kết nối DB & Realtime) [3/3]
...
**Chi tiết công việc:**
- [x] 1. **Thiết lập Supabase Client ở Frontend:**
...
- [x] 2. **Kích hoạt Realtime Subscriptions:**
...
- [x] 3. **Chuẩn hóa UI Right Sidebar theo `DESIGN.md`:**
...
### Giai đoạn 2: Cơ chế Downstream Repair & Quản lý Artifact (UI + Logic) [3/3]

**Mục tiêu:** Hiện thực hóa cơ chế quản lý Artifact thay vì "Rerun" toàn bộ (như mục 3 - ADR 02).

**Chi tiết công việc:**
- [x] 1. **Mở rộng giao diện Artifact (Expanded Mode):**
...
- [x] 2. **Logic tính toán Impact (Phía Server):**
